...
data_dir = '../../array train dataset/fish types/edge_%dx%d/' % (target_wnd_size[0], target_wnd_size[1])
...
##################
wnd_size = [220, 220]
x = tf.placeholder("float", shape=[None, wnd_size[0], wnd_size[1], 1])
y_ = tf.placeholder("float", shape=[None, 7])
x_image = x
...
while True:
    ...
    #
    x_data_batch = x_data_batch.reshape(1, target_wnd_size[0], target_wnd_size[1], 1)
