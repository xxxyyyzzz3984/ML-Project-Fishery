...
## fully connected
W_fc1 = weight_variable([3 * 3 * 128, 2048], name='wfc1_pnet')
b_fc1 = bias_variable([2048], name='bfc1_pnet')
...
W_fc2 = weight_variable([2048, 2], name='wfc2_pnet')
